...
public class AutoCompleteTextField:UITextField {
    ...
    override init(frame: CGRect) {
        ...
        commonInit()
        setupAutocompleteTable(superview!, y:999999)
    }
    ...
    public func setupAutocompleteTable(view:UIView, var y:CGFloat?){
        
        //let screenSize = UIScreen.mainScreen().bounds.size
        if y == 999999 {
            y = self.frame.size.height
        }
        let tableView = UITableView(frame: CGRectMake(0, y!, 400, 100.0))
