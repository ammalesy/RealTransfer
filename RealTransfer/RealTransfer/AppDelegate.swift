...
//var DOMAIN_NAME = PathUtil.sharedInstance.path //"ec2-52-10-22-26.us-west-2.compute.amazonaws.com"//"192.168.1.2"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        //AlertUtil.alert("", message: tokenString, cancleButton: "OK", atController: UIViewController.topViewController())
    }
    
    func application(application: UIApplication, didFailToRegisterForRemoteNotificationsWithError error: NSError) {
        print("Failed to register:", error)
        //AlertUtil.alert("", message: error.description, cancleButton: "OK", atController: UIViewController.topViewController())
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.mint.RealTransfer" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("RealTransfer", withExtension: "momd")!
